...
REQUIRED = {
    ...
    "marketplace/application/auth_runtime_server.py": b"# authenticated foreground runtime seam\n",
    ...
    "marketplace/application/auth_startup_composition.py": (
        b"# one-shot authenticated startup composition\n"
    ),
...
class PackageArtifactGateTests(unittest.TestCase):
    ...
    def test_missing_auth_http_composition_member_is_rejected(self):
        self._assert_required_member_rejected_when_missing(
    ...
    def test_missing_auth_launch_member_is_rejected(self):
        self._assert_required_member_rejected_when_missing(
            "marketplace/application/auth_launch.py"
        )

    def test_missing_auth_runtime_server_member_is_rejected(self):
        self._assert_required_member_rejected_when_missing(
            "marketplace/application/auth_runtime_server.py"
        )

    def test_missing_auth_startup_composition_member_is_rejected(self):
        self._assert_required_member_rejected_when_missing(
            "marketplace/application/auth_startup_composition.py"
        )
    ...
    def test_missing_auth_verification_method_evidence_member_is_rejected(self):
        self._assert_required_member_rejected_when_missing(
